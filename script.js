...
var EstacionamentoFront = /** @class */ (function () {
    ...
    EstacionamentoFront.prototype.adicionar = function (carro, salvar) {
        ...
        row.innerHTML = "\n                <td>".concat(carro.nome, "</td>\n                <td>").concat(carro.placa, "</td>\n                <td data-time=\"").concat(carro.entrada, "\">\n                    ").concat(carro.entrada.toLocaleString("pt-BR", {
            hour: "numeric",
            minute: "numeric",
...
var Estacionamento = /** @class */ (function () {
    ...
    Estacionamento.prototype.encerrar = function (info) {
        ...
        var msg = "\n      O ve\u00EDculo ".concat(info.nome, " de placa ").concat(info.placa, " permaneceu ").concat(tempo, " estacionado.\n      \n\n Deseja encerrar?\n    ");
        if (!confirm(msg))
            return;
